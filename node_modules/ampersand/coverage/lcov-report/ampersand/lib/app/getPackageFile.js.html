...
<html lang="en">
<head>
    <title>Code coverage report for ampersand/lib/app/getPackageFile.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ampersand/lib/app/getPackageFile.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">ampersand/lib/app/</a> &#187; getPackageFile.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (config.author) {
