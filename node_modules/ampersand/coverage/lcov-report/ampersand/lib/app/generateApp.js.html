...
<html lang="en">
<head>
    <title>Code coverage report for ampersand/lib/app/generateApp.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">ampersand/lib/app/generateApp.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">ampersand/lib/app/</a> &#187; generateApp.js</div>
</div>
<div class="body">
...
module.exports = function (options, cb) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!options.title || !options.projectFolder) {
